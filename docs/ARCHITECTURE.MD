...
- **Layers**:
  ...
  - `services/`:
    ...
    - `tailoring/`: `RoleClassifier`, `EvidenceScorer`, `DiverseEvidenceSelector`, `AdaptiveSummaryBuilder`, `ProvenanceVerifier`, `latex_generator.py`, `latex_compiler.py`, `cover_letter_generator.py`.
